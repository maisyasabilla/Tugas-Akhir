        ...
        <div class="col-md-12">
            <div class="card p-30">
                ...
                <div class="card-body pl-0 pr-0 fs-15">
                    <form class="w-100" action="<?= base_url() ?>/perjalanancontrol/tambah" method="post">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">No. Perjalanan</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="id_perjalanan"></input>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nama Karyawan</label>
                            <div class="col-sm-9">
                            <select class="custom-select mr-sm-2" name="nip" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <select class="custom-select mr-sm-2" name="alat_angkut" required>
                    ...
                    <a href="<?php echo base_url('perjalanan_dinas/tambah_perjalanan');?>"><button class="col-sm-4 floatr mr-10 fs-12 ls-3 fw-600 bg-oranye btn-login no-br" style="height: 35px; width: 220px"><i class="fa fa-times"></i> Batal</button></a>
                </div>
            </div>
        </div>
    </div>
